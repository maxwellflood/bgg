...
<!-- Package Features -->
			<div class="background-white">
                ...
                <?= $page->introCopy()->html() ?>
					...
					<div class="row med-padding-bottom center" data-aos="fade-up">
						<div class="col-12">
								<div class="controls">
										<h3>Show me:</h3>
				            <button type="button" class="control button-games" data-filter="all">All games</button>
				            <button type="button" class="control button-games" data-filter=".casino">Casino Games</button>
				            <button type="button" class="control button-games" data-filter=".garden">Garden Games</button>
				            <button type="button" class="control button-games" data-filter=".sports">Sports Games</button>
				        </div>
						</div>
					</div>
