      ...
      <div class="container">
        ...
        <div class="row lg-padding-bottom" data-aos="fade-up">
          <div class="flex-center">
            ...
            <div class="col-8">
              <img src="../assets/images/pl-1200x800.png" alt="" data-echo="../content/home/<?= $page->block01Image()->html() ?>">
            </div>
            <!-- <div class="col-1 hidden-sm"></div> -->
            <div class="col-4 as-center">
              <h2><?= $page->block01Title()->html() ?></h2>
              <p><?= $page->block01Text()->html() ?></p>
              <a class="button" href="../<?= $page->block01Link()->html() ?>">
        ...
        <div class="row lg-padding-bottom" data-aos="fade-up">
          <div class="flex-center">
            ...
            <div class="col-4 as-center mob-second-el">
              ...
              <a class="button" href="../<?= $page->block02Link()->html() ?>">
                <button type="button" name="button" class="button-dark-green-white">Learn more</button>
              </a>
            </div>
            <!-- <div class="col-1 hidden-sm mob-second-el"></div> -->
            <div class="col-8 mob-first-el">
              <img src="../assets/images/pl-1200x800.png" alt="" data-echo="../content/home/<?= $page->block02Image()->html() ?>">
            </div>
          </div>
        </div>
        ...
        <div class="row lg-padding-bottom" data-aos="fade-up">
          <div class="flex-center">
            ...
            <div class="col-8">
              <img src="../assets/images/pl-1200x800.png" alt="" data-echo="../content/home/<?= $page->block03Image()->html() ?>">
            </div>
            <!-- <div class="col-1 hidden-sm"></div> -->
            <div class="col-4 as-center">
              <h2><?= $page->block03Title()->html() ?></h2>
              <p><?= $page->block03Text()->html() ?></p>
              <a class="button" href="../<?= $page->block03Link()->html() ?>">
                <button type="button" name="button" class="button-dark-green-white">Learn more</button>
              </a>
            </div>
          </div>
